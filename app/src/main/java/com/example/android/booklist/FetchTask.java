 ...
 */
class FetchTask extends AsyncTask<String, Void, ArrayList<TheBook>> {
    ...
    public interface AsyncResponse {
        void processFinish(ArrayList<TheBook> output);
    }
     ...
     */
    @Override
    protected ArrayList<TheBook> doInBackground(String... params) {
        ...
        if (jsonResults != null) {
            try {
                ...
                ArrayList<TheBook> parsedResults = new ArrayList<>();
                ...
                for (int i = 0; i < countResults; i++) {
                    ...
                    TheBook mBook = new TheBook(bookTitle, bookAuthorsString, bookSmallThumbnail);
                    // Add it to the array
     ...
     */
    @Override
    protected void onPostExecute(ArrayList<TheBook> parsedResults) {
